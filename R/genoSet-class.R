...
setMethod("haplo", signature=signature(.Object="genoSet"),
          function(.Object, wgt=NULL, ...){
              ...
              geno <- haplo.stats::geno1to2(genoSeq(.Object), locus.label=nameSNP(.Object))
              
              ## haplotype reconstruction & frequency estimation
              em <- haplo.stats::haplo.em(geno=geno, locus.label=nameSNP(.Object), 
                             miss.val=NA, weight=wgt,
                             control=haplo.stats::haplo.em.control(loci.insert.order=NULL, insert.batch.size=3, min.posterior=0.01),
                             ...
                             )
